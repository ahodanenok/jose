...
public class JweBuilderTest {
    ...
    public void testJsonFlat_DirectEncryption() {
        ...
        assertEquals("{\"protected\":\"eyJhbGciOiJkaXIiLCJlbmMiOiJBMTI4R0NNIn0\",\"unprotected\":{\"foo\":\"bar\"},\"aad\":\"qw\",\"iv\":\"QW8WYOb0ce1F4jX1\",\"ciphertext\":\"VcTSRRHJU4thjUU57A\",\"tag\":\"syIUfhOwkhNSIifh2d9XRw\"}", jwe.asString());
    }

    @Test
    public void testJson_DirectEncryption() {
        Jwe jwe = Jwe.builder()
            .withPayload(TestUtils.bytes(0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x2c, 0x20, 0x77, 0x6f, 0x72, 0x6c, 0x64, 0x21))
            .withProtectedHeader()
                .param(JweHeaderNames.ALGORITHM, "dir")
        ...
        assertEquals("{\"protected\":\"eyJhbGciOiJkaXIiLCJlbmMiOiJBMTI4R0NNIn0\",\"unprotected\":{\"x\":1},\"recipients\":[{\"header\":{\"y\":2}},{\"header\":{\"z\":3}}],\"aad\":\"qw\",\"iv\":\"QW8WYOb0ce1F4jX1\",\"ciphertext\":\"VcTSRRHJU4thjUU57A\",\"tag\":\"syIUfhOwkhNSIifh2d9XRw\"}", jwe.asString());
    }
}
